  ...
  return (
    ...
    >
      ...
      <input
        ...
        {...props}
        ref={ref}
        className={`${props.inputClassName} h-12 outline-none placeholder:text-[var(--second-gray)] w-full placeholder:xl:text-lg  placeholder:text-base bg-transparent border-none `}
